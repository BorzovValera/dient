...
$count_query = "SELECT COUNT(*) FROM tovar WHERE category = 'Сантехника'";
...
$sql = "SELECT id, nazvanie, category, price, img, nalichie, opisanie FROM tovar WHERE category = 'Сантехника'";
if ($search) {
