...
$count_query = "SELECT COUNT(*) FROM tovar WHERE category = 'Инструменты'";
...
$sql = "SELECT id, nazvanie, category, price, img, nalichie, opisanie FROM tovar WHERE category = 'Инструменты'";
if ($search) {
